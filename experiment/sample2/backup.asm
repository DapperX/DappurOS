...
LABEL_BEGIN:
	...
	mov	[LABEL_DESC_CODE32 + 2], ax    ;设置基地址1（0-15位）
	shr	eax, 16
	mov	[LABEL_DESC_CODE32 + 4], al    ;设置基地址2（16-23位）
	mov	[LABEL_DESC_CODE32 + 7], ah    ;设置基地址3（24-31位）
...
LABEL_SEG_CODE32:
	...
	mov	edi, (80 * 4 + 6) * 2	; 屏幕第 11 行, 第 79 列。
